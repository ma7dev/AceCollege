  ...
  <div id="site-content">
	    ...
	    <form action="../app/insertTask.php?" method="post">
		    <div>
		        ...
		        <input type="text" name="title" id="title" placeholder="Buy Groceries" required>
		    </div>
		    <div>
		    ...
		    <div>
		        ...
		        <input type="text" name="description" id="description" placeholder="Milk, Bananas, Eggs, etc.">
		    </div>
		    <div>
		        <label for="magnitude">Priority  (1-4):</label><input type="number" name="magnitude" min="1" max="4" value="4" required>
		    </div>
