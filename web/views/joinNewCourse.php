  ...
  <script type="text/javascript">
    ...
    for (var i = 0; i < ernollBtn.length; i++) {
       ernollBtn[i].addEventListener('click', function(){
        ...
        window.location.href = "../app/enrollCourse.php?userID=<?php echo $user ?>&courseID=" +ernollBtnByID;
       });
    }
    ...
    for (var i = 0; i < ernolledBtn.length; i++) {
       ernolledBtn[i].addEventListener('click', function(){
        ...
        window.location.href = "../app/leaveCourse.php?userID=<?php echo $user ?>&courseID=" +ernolledBtnByID;
       });
    }
  </script>
</body>
