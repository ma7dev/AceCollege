...
<body>
  ...
  <div id="site-content">
    <form action="editResultTask.php" method="post">
    <p>
        <label for="tID">Type the tID that you want to change: </label>
	...
	<p>
        <label for="tag">Completion: </label>
        <input type="text" name="completion" id="completion">
    </p>
    </p>
